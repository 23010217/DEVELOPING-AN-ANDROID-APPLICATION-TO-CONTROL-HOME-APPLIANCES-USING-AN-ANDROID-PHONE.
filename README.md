...
## PROGRAM:package com.example.appliancecontrol;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fanOn.setOnClickListener(v -> fanStatus.setText("Fan: ON"));
        fanOff.setOnClickListener(v -> fanStatus.setText("Fan: OFF"));

        lightOn.setOnClickListener(v -> lightStatus.setText("Light: ON"));
        lightOff.setOnClickListener(v -> lightStatus.setText("Light: OFF"));

        acOn.setOnClickListener(v -> acStatus.setText("AC: ON"));
        acOff.setOnClickListener(v -> acStatus.setText("AC: OFF"));
    }
}
...
<ScrollView xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <LinearLayout
        ...
        <TextView
            ...
            android:layout_width="match_parent"
            android:layout_height="wrap_content"
            android:text="Appliance Control Panel"
...
## OUTPUT: 
<img width="988" height="522" alt="image" src="https://github.com/user-attachments/assets/84dcbc05-fa6b-45d8-ac85-f68d7755b00f" />
